...
public class Descifrar {
    ...
    public static ArrayList<Integer> plaintext;
    ...
    public Descifrar (String textoCifrado, String llave){
        ...
        //ConvertBits convertBits = new ConvertBits(textoCifrado);   // Para descifrar una entrada en String
        ConvertHexa convertBits = new ConvertHexa(textoCifrado);    // Para descifrar una entrada en Hexadecimal
    ...
    //Se crean bloques de 64 bits, para plainTexts largos
    private void crearBloques(ArrayList<Integer> text){
        while (!text.isEmpty()) {
            ...
            IP(bloque);
            //Creacion de L0 y R0
            R16.addAll(bloqueIP.subList(0, 32));
            L16.addAll(bloqueIP.subList(32, bloqueIP.size()));
    ...
    private void IPinv (ArrayList<Integer> bloqueIzq, ArrayList<Integer> bloqueDer){
        ...
        plaintext.add(bloque.get(40-1));
        plaintext.add(bloque.get(8-1));
        plaintext.add(bloque.get(48-1));
        plaintext.add(bloque.get(16-1));
        plaintext.add(bloque.get(56-1));
        plaintext.add(bloque.get(24-1));
        plaintext.add(bloque.get(64-1));
        plaintext.add(bloque.get(32-1));
        plaintext.add(bloque.get(39-1));
        plaintext.add(bloque.get(7-1));
        plaintext.add(bloque.get(47-1));
        plaintext.add(bloque.get(15-1));
        plaintext.add(bloque.get(55-1));
        plaintext.add(bloque.get(23-1));
        plaintext.add(bloque.get(63-1));
        plaintext.add(bloque.get(31-1));
        plaintext.add(bloque.get(38-1));
        plaintext.add(bloque.get(6-1));
        plaintext.add(bloque.get(46-1));
        plaintext.add(bloque.get(14-1));
        plaintext.add(bloque.get(54-1));
        plaintext.add(bloque.get(22-1));
        plaintext.add(bloque.get(62-1));
        plaintext.add(bloque.get(30-1));
        plaintext.add(bloque.get(37-1));
        plaintext.add(bloque.get(5-1));
        plaintext.add(bloque.get(45-1));
        plaintext.add(bloque.get(13-1));
        plaintext.add(bloque.get(53-1));
        plaintext.add(bloque.get(21-1));
        plaintext.add(bloque.get(61-1));
        plaintext.add(bloque.get(29-1));
        plaintext.add(bloque.get(36-1));
        plaintext.add(bloque.get(4-1));
        plaintext.add(bloque.get(44-1));
        plaintext.add(bloque.get(12-1));
        plaintext.add(bloque.get(52-1));
        plaintext.add(bloque.get(20-1));
        plaintext.add(bloque.get(60-1));
        plaintext.add(bloque.get(28-1));
        plaintext.add(bloque.get(35-1));
        plaintext.add(bloque.get(3-1));
        plaintext.add(bloque.get(43-1));
        plaintext.add(bloque.get(11-1));
        plaintext.add(bloque.get(51-1));
        plaintext.add(bloque.get(19-1));
        plaintext.add(bloque.get(59-1));
        plaintext.add(bloque.get(27-1));
        plaintext.add(bloque.get(34-1));
        plaintext.add(bloque.get(2-1));
        plaintext.add(bloque.get(42-1));
        plaintext.add(bloque.get(10-1));
        plaintext.add(bloque.get(50-1));
        plaintext.add(bloque.get(18-1));
        plaintext.add(bloque.get(58-1));
        plaintext.add(bloque.get(26-1));
        plaintext.add(bloque.get(33-1));
        plaintext.add(bloque.get(1-1));
        plaintext.add(bloque.get(41-1));
        plaintext.add(bloque.get(9-1));
        plaintext.add(bloque.get(49-1));
        plaintext.add(bloque.get(17-1));
        plaintext.add(bloque.get(57-1));
        plaintext.add(bloque.get(25-1));
    }
    
    private void creacionSubcadenas(){
        R15 = L16;
        E16 = expansion(L16);
        L15 = XOR(R16, innerFunction(XOR(crearLlaves.k16, E16)));
        R14 = L15;
        E15 = expansion(L15);
        L14 = XOR(R15, innerFunction(XOR(crearLlaves.k15, E15)));
        R13 = L14;
        E14 = expansion(L14);
        L13 = XOR(R14, innerFunction(XOR(crearLlaves.k14, E14)));
        R12 = L13;
        E13 = expansion(L13);
        L12 = XOR(R13, innerFunction(XOR(crearLlaves.k13, E13)));
        R11 = L12;
        E12 = expansion(L12);
        L11 = XOR(R12, innerFunction(XOR(crearLlaves.k12, E12)));
        R10 = L11;
        E11 = expansion(L11);
        L10 = XOR(R11, innerFunction(XOR(crearLlaves.k11, E11)));
        R9 = L10;
        E10 = expansion(L10);
        L9 = XOR(R10, innerFunction(XOR(crearLlaves.k10, E10)));
        R8 = L9;
        E9 = expansion(L9);
        L8 = XOR(R9, innerFunction(XOR(crearLlaves.k9, E9)));
        R7 = L8;
        E8 = expansion(L8);
        L7 = XOR(R8, innerFunction(XOR(crearLlaves.k8, E8)));
        R6 = L7;
        E7 = expansion(L7);
        L6 = XOR(R7, innerFunction(XOR(crearLlaves.k7, E7)));
        R5 = L6;
        E6 = expansion(L6);
        L5 = XOR(R6, innerFunction(XOR(crearLlaves.k6, E6)));
        R4 = L5;
        E5 = expansion(L5);
        L4 = XOR(R5, innerFunction(XOR(crearLlaves.k5, E5)));
        R3 = L4;
        E4 = expansion(L4);
        L3 = XOR(R4, innerFunction(XOR(crearLlaves.k4, E4)));
        R2 = L3;
        E3 = expansion(L3);
        L2 = XOR(R3, innerFunction(XOR(crearLlaves.k3, E3)));
        R1 = L2;
        E2 = expansion(L2);
        L1 = XOR(R2, innerFunction(XOR(crearLlaves.k2, E2)));
        R0 = L1;
        E1 = expansion(L1);
        L0 = XOR(R1, innerFunction(XOR(crearLlaves.k1, E1)));
    ...
    private ArrayList<Integer> innerFunction(ArrayList<Integer> Ri_1){
        ...
        //System.out.println(tempo.size()+"   tempo");
        return perI(tempo);
    }
    ...
    private ArrayList<Integer> buscar(ArrayList<Integer> Bi, int tabla){
        ...
        if (tabla == 17){
            ...
            //System.out.println(resultado + "r0 y c0 "+r0+" " +c0);
        }
        if (tabla == 23){
